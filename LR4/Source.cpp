...
public:
	LinksMap links;
	BorNode* fail;  // Ïðåäûäóùåå ñîñòîÿíèå äëÿ ôóíêöèè îòêàòà. Òîëüêî äëÿ root ðàâíî NULL.
	BorNode* term; // Áëèæàéøåå òåðìèíàëüíîå ñîñòîÿíèå. Åñëè îòñòóòñòâóåò - NULL
	int out;
...
void WriteInFile()
{
	ofstream wr("C:\\Users\\user\\Desktop\\Ó÷åáà\\3 êóðñ\\Óïðàâëåíèå êà÷åñòâîì ÏÎ\\ËÐ2\\LR4\\LR4\\str.txt");
...
{
	string line;
	//C:\\Users\\user\\Desktop\\Ó÷åáà\\3 êóðñ\\Óïðàâëåíèå êà÷åñòâîì ÏÎ\\ËÐ2\\LR2\\LR2\\str.txt
